...
fn inject() -> Result<()> {
    ...
    let input_file = Path::new("assets/av1_tests/regular_bl_start_code_4.ivf");
    let input_rpu = Path::new("assets/hevc_tests/regular_rpu.bin");

    let output_file = temp.child("injected_output.ivf");
    let expected_bl_rpu = Path::new("assets/av1_tests/regular_start_code_4.ivf");
